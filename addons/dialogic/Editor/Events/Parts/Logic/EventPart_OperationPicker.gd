...
var options = [
	{"text": "[ to be ]", "operation": "="},
	{"text": "[ to itself plus ]", "operation": "+"},
	{"text": "[ to itself minus ]", "operation": "-"},
	{"text": "[ to itself multiplied by ]", "operation": "*"},
	{"text": "[ to itself divided by ]", "operation": "/"},
]
