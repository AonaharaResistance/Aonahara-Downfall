...
onready var n: Dictionary = {
	# Dialog Text
	"theme_text_shadow":
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/HBoxContainer2/CheckBoxShadow",
	"theme_text_shadow_color":
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/HBoxContainer2/ColorPickerButtonShadow",
	"theme_text_color":
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/ColorPickerButton",
	"theme_font":
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/RegularFont/RegularFontButton",
	"theme_font_bold":
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/BoldFont/BoldFontButton",
	"theme_font_italic":
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/ItalicFont/ItalicFontButton",
	"theme_shadow_offset_x":
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/HBoxContainer/ShadowOffsetX",
	"theme_shadow_offset_y":
	$"VBoxContainer/TabContainer/Dialog Text/Column2/GridContainer/HBoxContainer/ShadowOffsetY",
	"theme_text_speed": $"VBoxContainer/TabContainer/Dialog Text/Column3/GridContainer/TextSpeed",
	"alignment":
	$"VBoxContainer/TabContainer/Dialog Text/Column3/GridContainer/HBoxContainer3/Alignment",
	"single_portrait_mode":
	$"VBoxContainer/TabContainer/Dialog Text/Column3/GridContainer/SinglePortraitModeCheckBox",
	# Dialog box
	"background_texture_button_visible":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/HBoxContainer3/CheckBox",
	"theme_background_image":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/HBoxContainer3/BackgroundTextureButton",
	"theme_background_color":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/HBoxContainer2/ColorPickerButton",
	"background_modulation":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/HBoxContainer6/CheckBox",
	"background_modulation_color":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/HBoxContainer6/ColorPickerButton",
	"background_full_width":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/HBoxContainer7/CheckBox",
	"dialog_box_anchor":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/PositionSelector",
	"theme_text_margin":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/HBoxContainer/BoxPaddingV",
	"theme_text_margin_h":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/HBoxContainer/BoxPaddingH",
	"size_w":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/HBoxContainer4/BoxSizeW",
	"size_h":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/HBoxContainer4/BoxSizeH",
	"box_margin_v":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/BoxMargin/MarginV",
	"box_margin_h":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer2/BoxMargin/MarginH",
	"theme_next_image":
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/NextIndicatorButton",
	"next_indicator_offset_x":
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/HBoxContainer2/NextOffsetX",
	"next_indicator_offset_y":
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/HBoxContainer2/NextOffsetY",
	"theme_background_color_visible":
	$"VBoxContainer/TabContainer/Dialog Box/Column/GridContainer/HBoxContainer2/CheckBox",
	"next_animation": $"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/NextAnimation",
	"next_indicator_scale":
	$"VBoxContainer/TabContainer/Dialog Box/Column2/GridContainer/HBoxContainer7/IndicatorScale",
	"theme_action_key":
	$"VBoxContainer/TabContainer/Dialog Box/Column3/GridContainer/BoxContainer/ActionOptionButton",
	"animation_show_time":
	$"VBoxContainer/TabContainer/Dialog Box/Column3/GridContainer/ShowTime/SpinBox",
	# Character Names
	"name_font":
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/RegularFont/NameFontButton",
	"name_auto_color": $"VBoxContainer/TabContainer/Name Label/Column/GridContainer/CharacterColor",
	"name_background_visible":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer2/CheckBox",
	"name_background":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer2/ColorPickerButton",
	"name_image":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer3/BackgroundTextureButton",
	"name_image_visible":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer3/CheckBox",
	"name_shadow":
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/HBoxContainer4/ColorPickerButtonShadow",
	"name_shadow_visible":
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/HBoxContainer4/CheckBoxShadow",
	"name_shadow_offset_x":
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/HBoxContainer/ShadowOffsetX",
	"name_shadow_offset_y":
	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/HBoxContainer/ShadowOffsetY",
	"name_bottom_gap":
	$"VBoxContainer/TabContainer/Name Label/Column3/GridContainer/HBoxContainer5/BottomGap",
	"name_horizontal_offset":
	$"VBoxContainer/TabContainer/Name Label/Column3/GridContainer/HBoxContainer5/HorizontalOffset",
	"name_background_modulation":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer6/CheckBox",
	"name_background_modulation_color":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer6/ColorPickerButton",
	"name_padding_x":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer/NamePaddingX",
	"name_padding_y":
	$"VBoxContainer/TabContainer/Name Label/Column2/GridContainer/HBoxContainer/NamePaddingY",
	"name_position":
	# Choice Buttons
	$"VBoxContainer/TabContainer/Name Label/Column3/GridContainer/HBoxContainer/Positions",
	"button_fixed":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer2/FixedSize",
	"button_fixed_x":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer2/ButtonSizeX",
	"button_fixed_y":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer2/ButtonSizeY",
	"button_use_native":
	$"VBoxContainer/TabContainer/Choice Buttons/Column3/GridContainer/CheckBox",
	"button_use_custom":
	$"VBoxContainer/TabContainer/Choice Buttons/Column3/GridContainer/HBoxContainer5/CustomButtonsCheckBox",
	"button_custom_path":
	$"VBoxContainer/TabContainer/Choice Buttons/Column3/GridContainer/HBoxContainer5/CustomButtonsButton",
	"button_padding_x":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer/TextOffsetH",
	"button_padding_y":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer/TextOffsetV",
	"button_separation":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/VerticalSeparation",
	"button_layout": $"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/Layout",
	"button_position_on_screen":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/PositionOnScreenOptionButton",
	"button_offset_x":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer3/ButtonOffsetX",
	"button_offset_y":
	$"VBoxContainer/TabContainer/Choice Buttons/Column2/GridContainer/HBoxContainer3/ButtonOffsetY",
	...
	# Glossary
	"glossary_title_font":
	$VBoxContainer/TabContainer/Glossary/Column3/GridContainer/TitleFont/TitleFontButton,
	"glossary_text_font":
	$VBoxContainer/TabContainer/Glossary/Column3/GridContainer/TextFont/TextFontButton,
	"glossary_extra_font":
	$VBoxContainer/TabContainer/Glossary/Column3/GridContainer/ExtraFont/ExtraFontButton,
	"glossary_highlight_color":
	$VBoxContainer/TabContainer/Glossary/Column/GridContainer/HighlightColorPicker,
	"glossary_title_color":
	$VBoxContainer/TabContainer/Glossary/Column3/GridContainer/TitleColorPicker,
	"glossary_text_color":
	$VBoxContainer/TabContainer/Glossary/Column3/GridContainer/TextColorPicker,
	"glossary_extra_color":
	$VBoxContainer/TabContainer/Glossary/Column3/GridContainer/ExtraColorPicker,
	"glossary_background_panel":
	$VBoxContainer/TabContainer/Glossary/Column/GridContainer/BackgroundPanel/BgPanelButton,
	"glossary_enabled":
	$VBoxContainer/TabContainer/Glossary/Column2/GridContainer/ShowGlossaryCheckBox,
	# Audio
	"audio_pickers":
	{
...
func _ready() -> void:
	...
	if get_constant("dark_theme", "Editor"):
		$VBoxContainer/HBoxContainer3/PreviewButton.icon = load(
			"res://addons/dialogic/Images/Plugin/plugin-editor-icon-dark-theme.svg"
		)
	else:
		$VBoxContainer/HBoxContainer3/PreviewButton.icon = load(
			"res://addons/dialogic/Images/Plugin/plugin-editor-icon-light-theme.svg"
		)

	$DelayPreviewTimer.one_shot = true
	$DelayPreviewTimer.connect("timeout", self, "_on_DelayPreview_timer_timeout")

	var title_style = $"VBoxContainer/TabContainer/Dialog Text/Column/SectionTitle".get(
		"custom_styles/normal"
	)
	title_style.set("bg_color", get_color("prop_category", "Editor"))

	$"VBoxContainer/TabContainer/Name Label/Column/GridContainer/RegularFont/NameFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/BoldFont/BoldFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/ItalicFont/ItalicFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Dialog Text/Column/GridContainer/RegularFont/RegularFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/TitleFont/TitleFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/TextFont/TextFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Glossary/Column3/GridContainer/ExtraFont/ExtraFontOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	$"VBoxContainer/TabContainer/Glossary/Column/GridContainer/BackgroundPanel/BGPanelOpen".icon = get_icon(
		"Edit", "EditorIcons"
	)
	...
	n["single_portrait_mode"].connect(
		"toggled", self, "_on_generic_checkbox", ["settings", "single_portrait_mode"]
	)
	n["theme_text_speed"].connect(
		"value_changed", self, "_on_generic_value_change", ["text", "speed"]
	)

	# Dialog Box tab
	n["theme_background_color_visible"].connect(
		"toggled", self, "_on_generic_checkbox", ["background", "use_color"]
	)
	n["background_texture_button_visible"].connect(
		"toggled", self, "_on_generic_checkbox", ["background", "use_image"]
	)
	n["background_modulation"].connect(
		"toggled", self, "_on_generic_checkbox", ["background", "modulation"]
	)
	n["background_full_width"].connect(
		"toggled", self, "_on_generic_checkbox", ["background", "full_width"]
	)
	n["animation_show_time"].connect(
		"value_changed", self, "_on_generic_value_change", ["animation", "show_time"]
	)
	n["box_margin_v"].connect(
		"value_changed", self, "_on_generic_value_change", ["box", "box_margin_v"]
	)
	n["box_margin_h"].connect(
		"value_changed", self, "_on_generic_value_change", ["box", "box_margin_h"]
	)

	n["next_indicator_scale"].connect(
		"value_changed", self, "_on_generic_value_change", ["next_indicator", "scale"]
	)

	# Name tab
	n["name_shadow_visible"].connect(
		"toggled", self, "_on_generic_checkbox", ["name", "shadow_visible"]
	)
	n["name_background_visible"].connect(
		"toggled", self, "_on_generic_checkbox", ["name", "background_visible"]
	)
	n["name_image_visible"].connect(
		"toggled", self, "_on_generic_checkbox", ["name", "image_visible"]
	)
	n["name_background_modulation"].connect(
		"toggled", self, "_on_generic_checkbox", ["name", "modulation"]
	)
	...
	# Glossary tab
	n["glossary_enabled"].connect(
		"toggled", self, "_on_generic_checkbox", ["definitions", "show_glossary"]
	)
...
func setup_advanced_containers():
	use_advanced_themes = DialogicResources.get_settings_config().get_value(
		"dialog", "advanced_themes", false
	)
...
func load_theme(filename):
	...
	# Background
	n["theme_background_image"].text = DialogicResources.get_filename_from_path(
		theme.get_value("background", "image", default_background)
	)
	n["background_texture_button_visible"].pressed = theme.get_value(
		"background", "use_image", true
	)
	...
	n["theme_next_image"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"next_indicator",
			"image",
			"res://addons/dialogic/Example Assets/next-indicator/next-indicator.png"
		)
	)
	...
	n["background_modulation_color"].color = Color(
		theme.get_value("background", "modulation_color", "#ffffffff")
	)
	...
	n["box_margin_v"].value = theme.get_value(
		"box", "box_margin_v", theme.get_value("box", "bottom_gap", 40)
	)
	n["box_margin_h"].value = theme.get_value(
		"box", "box_margin_h", theme.get_value("box", "bottom_gap", 40)
	)
	...
	n["button_custom_path"].text = DialogicResources.get_filename_from_path(
		theme.get_value("buttons", "custom_path", "")
	)
	...
	var default_style = [
		false, Color.white, false, Color.black, true, default_background, false, Color.white
	]
	...
	toggle_button_customization_fields(
		theme.get_value("buttons", "use_native", false),
		theme.get_value("buttons", "use_custom", false)
	)

	# Definitions
	n["glossary_highlight_color"].color = Color(
		theme.get_value("definitions", "color", "#ffffffff")
	)

	n["glossary_title_font"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"definitions", "font", "res://addons/dialogic/Example Assets/Fonts/GlossaryFont.tres"
		)
	)
	n["glossary_title_color"].color = Color(
		theme.get_value("definitions", "title_color", "#ffffffff")
	)

	n["glossary_text_font"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"definitions",
			"text_font",
			"res://addons/dialogic/Example Assets/Fonts/GlossaryFont.tres"
		)
	)
	n["glossary_text_color"].color = Color(
		theme.get_value("definitions", "text_color", "#ffffffff")
	)

	n["glossary_extra_font"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"definitions",
			"extra_font",
			"res://addons/dialogic/Example Assets/Fonts/GlossaryFont.tres"
	...
	n["glossary_extra_color"].color = Color(
		theme.get_value("definitions", "extra_color", "#ffffffff")
	)

	n["glossary_background_panel"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"definitions",
			"background_panel",
			"res://addons/dialogic/Example Assets/backgrounds/GlossaryBackground.tres"
		)
	)
	...
	n["theme_font"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"text", "font", "res://addons/dialogic/Example Assets/Fonts/DefaultFont.tres"
		)
	)
	n["theme_font_bold"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"text", "bold_font", "res://addons/dialogic/Example Assets/Fonts/DefaultBoldFont.tres"
		)
	)
	n["theme_font_italic"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"text",
			"italic_font",
			"res://addons/dialogic/Example Assets/Fonts/DefaultItalicFont.tres"
		)
	)
	...
	# Name
	n["name_font"].text = DialogicResources.get_filename_from_path(
		theme.get_value("name", "font", "res://addons/dialogic/Example Assets/Fonts/NameFont.tres")
	)
	...
	n["name_image"].text = DialogicResources.get_filename_from_path(
		theme.get_value(
			"name", "image", "res://addons/dialogic/Example Assets/backgrounds/background-2.png"
		)
	)
	n["name_background_modulation"].pressed = theme.get_value("name", "modulation", false)
	n["name_background_modulation_color"].color = Color(
		theme.get_value("name", "modulation_color", "#ffffffff")
	)
	...
	# Preview text
	n["text_preview"].text = theme.get_value(
		"text",
		"preview",
...
func _on_PreviewButton_pressed() -> void:
	...
	var preview_dialog = Dialogic.start(
		"", "", "res://addons/dialogic/Nodes/DialogNode.tscn", false, false
	)
	...
	preview_dialog.dialog_script = {
		...
		[
			{"event_id": "dialogic_024", "set_theme": current_theme},
			{
				...
				"character": preview_character_selected,
				"portrait": "",
...
func _on_FontOpen_pressed():
	...
	editor_reference.editor_interface.inspect_object(
		load(
			theme.get_value(
				"text", "font", "res://addons/dialogic/Example Assets/Fonts/DefaultFont.tres"
			)
	...
	editor_reference.editor_interface.inspect_object(
		load(
			theme.get_value(
				"text",
				"bold_font",
				"res://addons/dialogic/Example Assets/Fonts/DefaultBoldFont.tres"
			)
		)
	)
...
func _on_NameFontOpen_pressed():
	...
	editor_reference.editor_interface.inspect_object(
		load(
			theme.get_value(
				"name", "font", "res://addons/dialogic/Example Assets/Fonts/NameFont.tres"
			)
		)
	)
...
func _on_ShadowOffset_value_changed(_value) -> void:
	...
	DialogicResources.set_theme_value(
		...
		"text",
		"shadow_offset",
		Vector2(n["theme_shadow_offset_x"].value, n["theme_shadow_offset_y"].value)
	)
	_on_PreviewButton_pressed()  # Refreshing the preview
...
func _on_TextMargin_value_changed(value) -> void:
	if loading:
		return
	var final_vector = Vector2(n["theme_text_margin"].value, n["theme_text_margin_h"].value)
...
func _on_ColorPicker_Background_texture_modulation_color_changed(color) -> void:
	if loading:
		return
	DialogicResources.set_theme_value(
		current_theme, "background", "modulation_color", "#" + color.to_html()
	)
	$DelayPreviewTimer.start(0.5)  # Calling a timer so the update doesn't get triggered many times
...
func _on_NextAnimation_item_selected(index) -> void:
	DialogicResources.set_theme_value(
		current_theme, "next_indicator", "animation", n["next_animation"].get_item_text(index)
	)
	_on_PreviewButton_pressed()  # Refreshing the preview
...
func _on_NextOffset_value_changed(value):
	...
	var offset_value = Vector2(
		n["next_indicator_offset_x"].value, n["next_indicator_offset_y"].value
	)
...
func _on_ActionOptionButton_item_selected(index) -> void:
	if loading:
		return
	DialogicResources.set_theme_value(
		current_theme, "settings", "action_key", n["theme_action_key"].text
	)
...
func _on_ColorPicker_NameLabel_modulation_color_changed(color) -> void:
	if loading:
		return
	DialogicResources.set_theme_value(
		current_theme, "name", "modulation_color", "#" + color.to_html()
	)
	$DelayPreviewTimer.start(0.5)  # Calling a timer so the update doesn't get triggered many times
...
func _on_name_BottomGap_value_changed(value) -> void:
	...
	DialogicResources.set_theme_value(
		current_theme, "name", "bottom_gap", n["name_bottom_gap"].value
	)
	DialogicResources.set_theme_value(
		current_theme, "name", "horizontal_offset", n["name_horizontal_offset"].value
	)
	_on_PreviewButton_pressed()  # Refreshing the preview
...
func _on_ButtonSize_value_changed(value):
	...
	DialogicResources.set_theme_value(
		...
		"buttons",
		"fixed_size",
		Vector2(n["button_fixed_x"].value, n["button_fixed_y"].value)
	)
	_on_PreviewButton_pressed()  # Refreshing the preview
...
func _on_ButtonOffset_value_changed(value) -> void:
	if loading:
		return
	var final_vector = Vector2(n["button_padding_x"].value, n["button_padding_y"].value)
...
func _on_modifier_button_image_selected(path, _target):
	...
	n["button_" + current_choice_modifier_selected].get_node("BackgroundTexture/Button").text = DialogicResources.get_filename_from_path(
		path
	)
...
func _on_Glossary_TitleColorPicker_color_changed(color):
	if loading:
		return
	DialogicResources.set_theme_value(
		current_theme, "definitions", "title_color", "#" + color.to_html()
	)
	$DelayPreviewTimer.start(0.5)  # Calling a timer so the update doesn't get triggered many times
...
func _on_Glossary_TextColorPicker_color_changed(color):
	if loading:
		return
	DialogicResources.set_theme_value(
		current_theme, "definitions", "text_color", "#" + color.to_html()
	)
	$DelayPreviewTimer.start(0.5)  # Calling a timer so the update doesn't get triggered many times
...
func _on_Glossary_ExtraColorPicker_color_changed(color):
	if loading:
		return
	DialogicResources.set_theme_value(
		current_theme, "definitions", "extra_color", "#" + color.to_html()
	)
	$DelayPreviewTimer.start(0.5)  # Calling a timer so the update doesn't get triggered many times
...
func _on_audio_data_updated(section):
	DialogicResources.set_theme_value(
		current_theme, "audio", section, n["audio_pickers"][section].get_data()
	)
	_on_PreviewButton_pressed()
