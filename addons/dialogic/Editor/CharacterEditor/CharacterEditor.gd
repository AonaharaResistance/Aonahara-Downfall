...
onready var nodes = {
	...
	"mirror_portraits_checkbox":
	$HBoxContainer/VBoxContainer/HBoxContainer/MirrorOption/MirrorPortraitsCheckBox,
	...
	"new_portrait_button":
	$HBoxContainer/Container/ScrollContainer/VBoxContainer/HBoxContainer/Button,
	"import_from_folder_button":
	$HBoxContainer/Container/ScrollContainer/VBoxContainer/HBoxContainer/ImportFromFolder,
...
func _ready():
	$"HBoxContainer/Container/ScrollContainer/VBoxContainer/HBoxContainer/Button".text = DTS.translate(
		"  Add new portrait"
	)
	$"HBoxContainer/Container/ScrollContainer/VBoxContainer/HBoxContainer/ImportFromFolder".text = DTS.translate(
		"  Import images from folder"
	)

	editor_reference = find_parent("EditorView")
	nodes["new_portrait_button"].connect("pressed", self, "_on_New_Portrait_Button_pressed")
	nodes["import_from_folder_button"].connect(
		"pressed", self, "_on_Import_Portrait_Folder_Button_pressed"
	)
...
func create_character():
	...
	var character = {
		"color": "#ffffff", "id": character_file, "portraits": [], "mirror_portraits": false
	}
				...
				if ".svg" in file_lower or ".png" in file_lower:
					if not ".import" in file_lower:
						...
						create_portrait_entry(
							DialogicResources.get_filename_from_path(file_name), final_name
						)
