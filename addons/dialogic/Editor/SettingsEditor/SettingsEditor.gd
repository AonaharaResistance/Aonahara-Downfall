...
onready var nodes = {
	# Theme
	"themes":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer/HBoxContainer/ThemeOptionButton,
	"advanced_themes":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer/HBoxContainer2/AdvancedThemes,
	"canvas_layer":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer/HBoxContainer3/CanvasLayer,
	# Dialog
	"new_lines": $VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer2/NewLines,
	"remove_empty_messages":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer/RemoveEmptyMessages,
	"auto_color_names":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer3/AutoColorNames,
	"propagate_input":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer4/PropagateInput,
	"dim_characters":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer5/DimCharacters,
	"text_event_audio_enable":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer7/EnableVoices,
	"text_event_audio_default_bus":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/TextAudioDefaultBus/AudioBus,
	"translations":
	$VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer2/HBoxContainer6/Translations,
	# Save
	"autosave": $VBoxContainer/HBoxContainer3/VBoxContainer/VBoxContainer3/HBoxContainer/Autosave,
	# Input Settings
	"delay_after_options":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/VBoxContainer/HBoxContainer/LineEdit,
	"default_action_key":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/VBoxContainer/HBoxContainer2/DefaultActionKey,
	"new_custom_event_open":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/HBoxContainer/NewCustomEvent,
	"new_custom_event_section":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/CreateCustomEventSection,
	"new_custom_event_name":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/CreateCustomEventSection/CeName,
	"new_custom_event_directory":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/CreateCustomEventSection/CeDirectory,
	"new_custom_event_id":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/CreateCustomEventSection/CeEventId,
	"new_custom_event_create":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/CreateCustomEventSection/HBoxContainer/CreateCustomEvent,
	"new_custom_event_cancel":
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/CreateCustomEventSection/HBoxContainer/CancelCustomEvent,
}
...
var INPUT_KEYS := ["delay_after_options", "default_action_key"]
...
func _ready():
	...
	nodes["advanced_themes"].connect(
		"toggled", self, "_on_item_toggled", ["dialog", "advanced_themes"]
	)
	...
	nodes["default_action_key"].connect(
		"item_selected", self, "_on_default_action_key_item_selected"
	)

	AudioServer.connect("bus_layout_changed", self, "update_bus_selector")
	nodes["text_event_audio_default_bus"].connect(
		"item_selected", self, "_on_text_audio_default_bus_item_selected"
	)
	...
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/HBoxContainer/Message.set(
		"custom_colors/font_color", get_color("error_color", "Editor")
	)
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/HBoxContainer/CustomEventsDocs.icon = get_icon(
		"HelpSearch", "EditorIcons"
	)
	$VBoxContainer/HBoxContainer3/VBoxContainer2/CustomEvents/HBoxContainer/CustomEventsDocs.connect(
		"pressed", self, "open_custom_event_docs"
	)
...
func _on_default_action_key_presssed() -> void:
	...
	nodes["default_action_key"].add_item(
		settings.get_value("input", "default_action_key", "[Default]")
	)
...
func update_bus_selector():
	if nodes["text_event_audio_default_bus"] != null:
		...
		if nodes["text_event_audio_default_bus"].get_item_count():
			previous_selected_bus_name = nodes["text_event_audio_default_bus"].get_item_text(
				max(0, nodes["text_event_audio_default_bus"].selected)
			)
...
func open_custom_event_docs():
	editor_reference.get_node("MainPanel/MasterTreeContainer/MasterTree").select_documentation_item(
		"res://addons/dialogic/Documentation/Content/Events/Custom Events/CreateCustomEvents.md"
	)
...
func create_custom_event():
	...
	for file in [
		"EventBlock.tscn",
		"Stylebox.tres",
		"EventPart_Example.gd",
		"EventPart_Example.tscn",
		"event_yourname_000.gd"
	]:
		dir.copy("res://addons/dialogic/Example Assets/CustomEvents/" + file, dir_name + "/" + file)

	# rename the event handler script
	dir.rename(
		dir_name + "/event_yourname_000.gd",
		dir_name + "/event_" + nodes["new_custom_event_id"].text + ".gd"
	)
	...
	event_block_scene.event_icon = load(
		"res://addons/dialogic/Images/Event Icons/Main Icons/custom-event.svg"
	)
